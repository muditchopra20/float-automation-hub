-- Create enum types for execution status
CREATE TYPE execution_status AS ENUM ('queued', 'running', 'error', 'success');
...
ADD COLUMN json_definition JSONB DEFAULT '{}'::jsonb,
...
-- Add trigger for updated_at on workflows table
