  ...
  return (
    <div className="py-24 bg-gray-50">
      <div className="container">
        <div className="bg-gradient-to-r from-urban-blue to-violet rounded-2xl p-12 text-center relative overflow-hidden">
          {/* Abstract shapes */}
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 text-lg max-w-xl mx-auto mb-8 animate-fade-in" style={{ animationDelay: "0.2s" }}>
              Join thousands of teams who are saving time and reducing errors with
              Flo AI's natural language automation platform.
            </p>
            <ButtonWithGlow
              size="lg"
              className="bg-white text-urban-blue hover:bg-white/90 animate-fade-in"
